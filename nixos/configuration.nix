...
let
  # Import home-manager from GitHub
...
{  
  ...
  home-manager.users.andrewgari = { pkgs, ... }: {
    # Your Home Manager configs will go here
    imports = [ 
	./home.nix
    ];
    # This is required
    home.stateVersion = "24.11"; # Should match your NixOS version
  };
 home-manager.backupFileExtension = "backup"; 
  # Enable automatic login for the user.
  services.xserver.displayManager.autoLogin.enable = true;
  services.xserver.displayManager.autoLogin.user = "andrewgari";
